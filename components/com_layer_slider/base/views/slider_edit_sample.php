			...
			<tbody class="ls-sublayers ls-sublayer-sortable">
				<tr class="active">
					<td>
                        ...
                        <td colspan="2"><a href="javascript:;" onclick="localStorage.lsTransition=jQuery(this.parentNode.parentNode.parentNode).inputsToObj();" class="copy dashicons dashicons-admin-page" data-help="Copy all transition settings"></a>
                                        <a href="javascript:;" onclick="jQuery(this.parentNode.parentNode.parentNode).objToInputs(localStorage.lsTransition);" class="paste dashicons dashicons-clipboard" data-help="Paste all transition settings"></a></td>
                        ...
                        <td colspan="2"><a href="javascript:;" onclick="localStorage.lsStyle=jQuery(this.parentNode.parentNode.parentNode).inputsToObj();" class="copy dashicons dashicons-admin-page" data-help="Copy all style settings"></a>
                                        <a href="javascript:;" onclick="jQuery(this.parentNode.parentNode.parentNode).objToInputs(localStorage.lsStyle);" class="paste dashicons dashicons-clipboard" data-help="Paste all style settings"></a></td>
											</tr>
											<tr>
