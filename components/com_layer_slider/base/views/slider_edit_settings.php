		...
		<div class="ls-settings-contents">
			<table>
				...
				<tbody>
						  ...
						  <input type="hidden" name="backgroundimage" value="<?php echo !empty($slider['properties']['backgroundimage']) ? $slider['properties']['backgroundimage'] : '' ?>">
							<div class="ls-image ls-upload">
								<a href="javascript:;" onclick="openModal(this);" class="modal">
  								<div><img src="<?php echo apply_filters('ls_get_thumbnail', "", !empty($slider['properties']['backgroundimage']) ? $slider['properties']['backgroundimage'] : null) ?>" alt=""></div>
  							</a>	
								<a href="#">x</a>
							</div>
						</td>
					...
					<tr>
						<td><?php _e($lsDefaults['slider']['globalBGPosition']['name'], 'LayerSlider') ?></td>
						<td>
						...
						<td class="desc"><?php _e($lsDefaults['slider']['globalBGPosition']['desc'], 'LayerSlider') ?></td>
					</tr>

					<tr>
						<td><?php _e($lsDefaults['slider']['globalBGSize']['name'], 'LayerSlider') ?></td>
						<td>
							<div class="reset-parent">
						...
						<td class="desc"><?php _e($lsDefaults['slider']['globalBGSize']['desc'], 'LayerSlider') ?></td>
					</tr>

					<tr>
						<td><?php _e('Background repeat', 'LayerSlider') ?></td>
						<td><?php lsGetSelect($lsDefaults['slider']['globalBGRepeat'], $slider['properties']) ?></td>
						<td class="desc"><?php _e($lsDefaults['slider']['globalBGRepeat']['desc'], 'LayerSlider') ?></td>
					</tr>

					<tr>
						<td><?php _e('Background behaviour', 'LayerSlider') ?></td>
						<td><?php lsGetSelect($lsDefaults['slider']['globalBGBehaviour'], $slider['properties']) ?></td>
						<td class="desc"><?php _e($lsDefaults['slider']['globalBGBehaviour']['desc'], 'LayerSlider') ?></td>
					</tr>
