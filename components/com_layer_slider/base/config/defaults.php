...
$lsDefaults = array(
	...
	'slider' => array(
		...
		'globalBGSize' => array(
			...
			'desc' => __('Global background size of the slider. You can set the size in pixel or percent or constants: auto | cover | contain ', 'LayerSlider')
		),
    ...
    // background-attachment css option on all slides.
		...
		'globalBGRepeat' => array(
			...
			'desc' => __('Global background repeat of the slider.', 'LayerSlider'),
			'options' => array(
				'repeat' => __('Repeat', 'LayerSlider', 'LayerSlider'),
				'repeat-x' => __('Repeat-x', 'LayerSlider', 'LayerSlider'),
				'repeat-y' => __('Repeat-y', 'LayerSlider', 'LayerSlider'),
				'no-repeat' => __('No-repeat', 'LayerSlider', 'LayerSlider'),
			)
		),
    ...
    // background-attachment css option on all slides.
		...
		'globalBGBehaviour' => array(
			'value' => 'scroll',
			'name' => __('Background behaviour', 'LayerSlider'),
			'keys' => array('background_behaviour', 'globalBGBehaviour'),
			'desc' => __('If you want to set fixed position background, please use Fixed value.', 'LayerSlider'),
			'options' => array(
				'scroll' => __('Scroll', 'LayerSlider', 'LayerSlider'),
				'fixed' => __('Fixed', 'LayerSlider', 'LayerSlider')
			)
		),
